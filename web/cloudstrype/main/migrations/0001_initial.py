# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-05-18 04:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attrs', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('search', django.contrib.postgres.search.SearchVectorField(blank=True, editable=False, null=True)),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='files', to='main.Directory')),
            ],
            bases=(main.models.UidModelMixin, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='filechunks', to='main.File')),
            ],
        ),
        migrations.CreateModel(
            name='FileShare',
